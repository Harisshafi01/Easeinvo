...
const InvoicePreview: React.FC<InvoicePreviewProps> = ({ invoice, className = '' }) => {
  ...
  return (
    <div className={`w-full h-full bg-slate-200 dark:bg-slate-800 overflow-auto p-4 md:p-8 ${className}`}>
      <div 
        className="mx-auto w-[794px] shadow-2xl origin-top transition-transform scale-100 bg-white" 
