        ...
        <div className="flex flex-col lg:flex-row h-[calc(100vh-64px)] overflow-hidden">
          ...
          {showMobilePreview && (
            <div className="fixed inset-0 z-[60] bg-white dark:bg-black lg:hidden flex flex-col">
              ...
              <div className="flex-grow overflow-auto bg-gray-100 dark:bg-zinc-950 p-4 flex justify-center">
                <div className="origin-top scale-[0.35] sm:scale-[0.6] md:scale-[0.85]">
                  <InvoicePreview 
                    invoice={currentInvoice} 
                    className="!bg-transparent !p-0 !h-auto !overflow-visible" 
                  />
                </div>
              </div>
